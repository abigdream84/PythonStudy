...
class account(object):
    ...
    def __getPwd(self,user_id):
        ...
        try:
            user_pwd = self.__helper.select(sql,user_id)[0][0]
        except Exception as e:
            print(e)
        return user_pwd
    ...
    def resetFail(self,user_id,):
        sql = 'update account set fail_account = 0 where id = %s'
        try:
    ...
    def __getStat(self,user_id):
        ...
        try:
            status = self.__helper.select(sql,user_id)[0][0]
        except Exception as e:
            print(e)
        return status
